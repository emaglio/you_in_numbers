class User::UpdateChart < Trailblazer::Operation
  ...
  def update_chart!(options, model:, params:, **)
    ...
    obj_array[index][:y1][:show_scale] = (params["y1_select"] != "none") ? (params["y1_scale"] == "1" ) : false
    ...
    obj_array[index][:y2][:show_scale] = (params["y2_select"] != "none") ? (params["y2_scale"] == "1") : false
    ...
    obj_array[index][:y3][:show_scale] = (params["y3_select"] != "none") ? (params["y3_scale"] == "1") : false

    obj_array[index][:x][:name] = (params["x"] != "none") ? params["x"] : nil
    obj_array[index][:x][:time] = (params["x"] != "none") ? (params["x_time"] == "1") : nil
    obj_array[index][:x][:time_format] = (params["x"] != "none") ? params["x_format"] : nil

    obj_array[index][:show_vo2max][:show] = (params["vo2max_show"] == "1")
    obj_array[index][:show_vo2max][:colour] = params["vo2max_colour"]

    obj_array[index][:show_exer][:show] = (params["exer_show"] == "1")
    obj_array[index][:show_exer][:colour] = params["exer_colour"]

    obj_array[index][:show_AT][:show] = (params["at_show"] == "1")
    obj_array[index][:show_AT][:colour] = params["at_colour"]

    obj_array[index][:only_exer] = (params["only_exer"] == "1")
    true
  end

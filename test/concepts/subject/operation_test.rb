...
class SubjectOperationTest < MiniTest::Spec
  ...
  it "wrong input" do
    ...
    result["result.contract.default"].errors.messages.inspect.must_equal "{:email=>[\"Wrong format\"], :user_id=>[\"Can't be blank\"], :firstname=>[\"Can't be blank\"], :lastname=>[\"Can't be blank\"], :gender=>[\"Can't be blank\"], :dob=>[\"Can't be blank\"], :height=>[\"Can't be blank\", \"This must be greater than zero\"], :weight=>[\"Can't be blank\", \"This must be greater than zero\"]}"
  end
  ...
  it "unique subject and email" do
    ...
    result.failure?.must_equal true
    result["result.contract.default"].errors.messages.inspect.must_equal "{:firstname=>[\"Subject already present in the database\"]}"
  end

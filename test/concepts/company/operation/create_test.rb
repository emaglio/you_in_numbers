...
class CompanyOperationCreateTest < MiniTest::Spec
  it 'successfully create Company' do
    ...
    result = Company::Operation::Create.(
      {
        user_id: user['model'].id, name: 'My Company', address_1: 'address 1', address_2: 'address 2',
        city: 'Freshwater', postcode: '2096', country: 'Australia', email: 'company@email.com',
  ...
  it 'wrong input' do
    ...
    result = Company::Operation::Create.({}, 'current_user' => user)
